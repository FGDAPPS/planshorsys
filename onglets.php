...
<BODY onload="TabClick(0);">
  ...
  <!-- <form action="" method="POST"> -->
      <TR>
          <TD CLASS="TabBorderBottom TabCommon TabOff" id="tabs" name="tabs" ONCLICK="TabClick(0);"><NOBR>
          <?php if(!isset($_POST['submitDef'])){
            ?>
Définition plan
            <?php }if(isset($_POST['submitDef']) && isset($_POST['sousCond'])){
?>
Sous-condition
<?php 
...
<?php 
            ...
            ?>
              ...
              <TD CLASS="TabBorderBottom TabCommon TabOff" id="tabs" name="tabs" ONCLICK="TabClick(1);">  <NOBR>Upload plans</NOBR></TD>
             <!-- <TD  name="tabs" >Upload</TD> -->
...
<input type="submit" name="submitDef">
</form>
            </div>
         </DIV>
         <?php
         ...
         <DIV id="Content" name="Content">
           ...
           if (!isset($_POST['submitDef']) && !isset($_POST['subTypeC'])){
            ...
            <form enctype="multipart/form-data" action="" method="POST">
<label> Upload des plans</label>
<input type="file" name="listeDesPlans">
...
//  for($i=0;$i<$NoPaliers;$i++)
 ...
 // }
          ...
          <?php
                // }
                ?>
                <input type="submit" name="subSousCond">
              </form>
                <?php
  ...
  <input type="hidden" value="<?php echo $Articles ?>" name="Article">
        ...
        // $paliers= $_POST['NoPaliers'];
         ...
         ?>
              ...
              <input type="submit" name="subTypeC">
              </form>
       ...
       <tbody>
        ...
        $paliers= $_POST['NoPaliers'];
         ...
         <tr id='addrPalier0'>
           ...
           <td>
             <input type="text" name='uname' placeholder='"," between articles' class="form-control" />
           </td>
           <td>
           <select name='typeSouscond' class="form-control" ><option>Qte</option><option>CA</option></select>
           </td>
           <td>
             <input type="text" name='minSouscond' placeholder='Min to order sous cond' class="form-control" />
           </td>
           <td>
             <input type="text" name='uname' placeholder='De' class="form-control" />
           </td>
           <td>
              <input type="text" name='uname' placeholder='A' class="form-control" />
           </td>
           <td>
             <select name='Offre' class="form-control" ><option>AVS</option><option>GRATUITE</option><option>REMISE</option><option>GIFT</option></select>
           </td>
           <td>
